...
function createSparkline(canvasId,prices){
 ...
 sparklineCharts[canvasId]=new Chart(c,{type:'line',data:{labels:prices.map((_,i)=>i),datasets:[{data:prices,borderWidth:2,pointRadius:0,tension:0.35 borderColor: prices[prices.length - 1] >= prices[0]
    ? "#22c55e"
    : "#ef4444" ,
     fill : false                                                                                          }]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false},tooltip:{enabled:false}},scales:{x:{display:false},y:{display:false}}}});
}
